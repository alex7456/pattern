...
student_short2 = Student_short.new('5', 'Александров А.А., petrGit, Phone: 987-654-321')
...
puts "Student_short1: ID=#{student_short1.id}, Surname Initials=#{student_short1.surname_initials}, Git=#{student_short1.git}, Contact=#{student_short1.contact}"
puts "Student_short2: ID=#{student_short2.id}, Surname Initials=#{student_short2.surname_initials}, Git=#{student_short2.git}, Contact=#{student_short2.contact}"
